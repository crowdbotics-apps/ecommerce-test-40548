"""
Django settings for ecommerce_test_40548 project.
...
ROOT_URLCONF = 'ecommerce_test_40548.urls'
...
WSGI_APPLICATION = 'ecommerce_test_40548.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ecommerce_test_40548 API",
    "DESCRIPTION": "API documentation for ecommerce_test_40548 App",
    "VERSION": "v1",
}
